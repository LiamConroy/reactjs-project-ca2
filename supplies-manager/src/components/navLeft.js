...
const NavLeft = (props) => {
    ...
    return(
        ...
        <Link className = "text-link" to = "sales"><h3 className = "headerWhite">Sales</h3></Link>
        {/* <Link className = "text-link" to = "sales/users"><h3 className = "headerWhite pt-2"></h3></Link>         */}
        </div>

        <div className = "sidePad">
            <div className = "">

            <Link className = "text-link" to = "/admins/register"><p className = "smallText removemargin">Create Admin</p></Link>
            <p className = "removemargin smallText">Support</p>
            </div>
